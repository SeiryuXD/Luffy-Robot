...
def send_help(chat_id, text, keyboard=None):
    ...
    if not keyboard:
        ...
        # kb.append([InlineKeyboardButton(text='Support', url='https://t.me/NakamaUnity'),
                    ...
                    [
                        [
                            InlineKeyboardButton(
                                ...
                                url='https://t.me/NakamaUnity',
                            ),
                            InlineKeyboardButton(
                                text=gs(chat.id, "updates_channel_link_btn"),
                                url="https://t.me/NakamaUnityUpdates",
                            ),
                            InlineKeyboardButton(
            ...
            if args[0].lower() == "help":
                ...
                help_buttons.append(
                    [InlineKeyboardButton(text="Back", callback_data="help_back"),
                     InlineKeyboardButton(text='Support', url='https://t.me/NakamaUnity')]
                )
                send_help(
                    chat.id,
                    text,
